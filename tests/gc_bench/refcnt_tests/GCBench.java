...
//	5/7/2001 - Changed the teston longLivedTree to make it less likely
//		   to be statically evaluable by a compiler.  This should
//		   affect the running time only if the test was previously
//		   optimized out, which would have largely invalidated it
//		   anyway.
...
public class GCBench {
	...
	public static void main(String args[]) {
		...
		if (longLivedTree.left.right == null || array[1000] != 1.0/1000)
